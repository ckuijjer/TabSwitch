...
(function (r) {
  function x(l) {
    throw new RangeError(H[l]);
  }
  function k(l, t) {
    for (var C = l.length, y = []; C--; ) y[C] = t(l[C]);
    return y;
  }
  function m(l, t) {
    var C = l.split('@'),
  ...
  function d(l) {
    for (var t = [], C = 0, y = l.length, J, M; C < y; )
      (J = l.charCodeAt(C++)),
        55296 <= J && 56319 >= J && C < y
          ? ((M = l.charCodeAt(C++)),
            56320 == (M & 64512)
              ? t.push(((J & 1023) << 10) + (M & 1023) + 65536)
              : (t.push(J), C--))
          : t.push(J);
    return t;
  }
  ...
  var G = {
    ...
    toASCII: function (l) {
      return m(l, function (t) {
        return F.test(t) ? 'xn--' + h(t) : t;
      });
    },
    toUnicode: function (l) {
      return m(l, function (t) {
        return K.test(t) ? A(t.slice(4).toLowerCase()) : t;
      });
    },
  };
  if (
    ...
    else for (B in G) G.hasOwnProperty(B) && (p[B] = G[B]);
  else r.punycode = G;
})(this);
(function (r, x) {
  'object' === typeof module && module.exports
  ...
  var x = r && r.SecondLevelDomains,
    k = {
      ...
      has: function (m) {
        ...
        return E ? 0 <= E.indexOf(' ' + m.slice(q + 1, d) + ' ') : !1;
      },
      is: function (m) {
        var d = m.lastIndexOf('.');
        if (0 >= d || d >= m.length - 1 || 0 <= m.lastIndexOf('.', d - 1))
          return !1;
      ...
      get: function (m) {
        ...
        var E = k.list[m.slice(d + 1)];
        return !E || 0 > E.indexOf(' ' + m.slice(q + 1, d) + ' ')
          ? null
          : m.slice(q + 1);
      },
      noConflict: function () {
...
(function (r, x) {
  ...
  for (l in G)
    (d[l + 'PathSegment'] = t('pathname', G[l])),
      (d[l + 'UrnPathSegment'] = t('urnpath', G[l]));
  G = function (a, b, c) {
    return function (e) {
      var f = c
        ? function (I) {
  ...
  d.parseUserinfo = function (a, b) {
    ...
    -1 < f && (-1 === e || f < e)
      ? ((e = a.substring(0, f).split(':')),
        (b.username = e[0] ? d.decode(e[0]) : null),
        e.shift(),
        (b.password = e[0] ? d.decode(e.join(':')) : null),
        (a = c.substring(f + 1)))
  ...
  d.parseQuery = function (a, b) {
    ...
    for (var c = {}, e = a.split('&'), f = e.length, n, z, I = 0; I < f; I++)
      if (
        ((n = e[I].split('=')),
        (z = d.decodeQuery(n.shift(), b)),
        (n = n.length ? d.decodeQuery(n.join('='), b) : null),
        '__proto__' !== z)
      )
        if (B.call(c, z)) {
  ...
  d.buildQuery = function (a, b, c) {
    var e = '',
      ...
      n;
    for (f in a)
      if ('__proto__' !== f && B.call(a, f))
        if (A(a[f])) {
          var z = {};
          var I = 0;
          for (n = a[f].length; I < n; I++)
            void 0 !== a[f][I] &&
              void 0 === z[a[f][I] + ''] &&
              ((e += '&' + d.buildQueryParameter(f, a[f][I], c)),
              !0 !== b && (z[a[f][I] + ''] = !0));
        } else
  ...
  d.removeQuery = function (a, b, c) {
    var e;
    if (A(b)) for (c = 0, e = b.length; c < e; c++) a[b[c]] = void 0;
    else if ('RegExp' === E(b)) for (e in a) b.test(e) && (a[e] = void 0);
  ...
  d.hasQuery = function (a, b, c, e) {
    switch (E(b)) {
      ...
      case 'RegExp':
        ...
        return !1;
      case 'Object':
        for (var n in b) if (B.call(b, n) && !d.hasQuery(a, n, b[n])) return !1;
        return !0;
      default:
        throw new TypeError(
    ...
    switch (E(c)) {
      ...
      case 'RegExp':
        return A(a[b]) ? (e ? p(a[b], c) : !1) : !(!a[b] || !a[b].match(c));
      case 'Number':
        c = String(c);
      case 'String':
  ...
  g.href = function (a, b) {
    ...
    if ('string' === typeof a || a instanceof String)
      ...
      e = e ? a._parts : a;
      for (c in e)
        'query' !== c && B.call(this._parts, c) && (this._parts[c] = e[c]);
  ...
  g.is = function (a) {
    ...
    this._parts.hostname &&
      ...
      (z = f && d.idn_expression.test(this._parts.hostname)),
      (I = f && d.punycode_expression.test(this._parts.hostname)));
  ...
  g.tld = function (a, b) {
    ...
    if (void 0 === a) {
      ...
      return !0 !== b && k && k.list[c.toLowerCase()]
        ? k.get(this._parts.hostname) || c
        : c;
    }
    if (a)
  ...
  g.suffix = function (a, b) {
    ...
    '.' === a.charAt(0) && (a = a.substring(1));
    if ((c = this.suffix()))
      e = a ? new RegExp(q(c) + '$') : new RegExp(q('.' + c) + '$');
    else {
      if (!a) return this;
  ...
  g.segmentCoded = function (a, b, c) {
    ...
    if (A(b)) for (f = 0, e = b.length; f < e; f++) b[f] = d.encode(b[f]);
  ...
  g.normalizeHostname = function (a) {
    this._parts.hostname &&
      (this.is('IDN') && r
        ...
        : this.is('IPv6') &&
          x &&
          (this._parts.hostname = x.best(this._parts.hostname)),
  ...
  g.readable = function () {
    ...
    if (a._parts.query) {
      for (
        var c = '', e = 0, f = a._parts.query.split('&'), n = f.length;
        e < n;
        e++
      ) {
        var z = (f[e] || '').split('=');
        c +=
          '&' +
          d
            .decodeQuery(z[0], this._parts.escapeQuerySpace)
            .replace(/&/g, '%26');
        void 0 !== z[1] &&
          (c +=
            '=' +
            d
              .decodeQuery(z[1], this._parts.escapeQuerySpace)
              .replace(/&/g, '%26'));
      }
      b += '?' + c.substring(1);
    }
  ...
  g.equals = function (a) {
    ...
    for (e in b)
      if (B.call(b, e)) {
        if (!A(b[e])) {
          if (b[e] !== n[e]) return !1;
        } else if (!D(b[e], n[e])) return !1;
        a[e] = !0;
      }
    for (e in n) if (B.call(n, e) && !a[e]) return !1;
    return !0;
  };
...
(function (r, x) {
  ...
  k.expandNamed = function (h, p, D, u, K, F) {
    ...
    for (B = h.val.length; G < B; G++) {
      if (K) {
        var l = r[H](h.val[G][1].substring(0, K));
        2 === h.type && (g = r[H](h.val[G][0].substring(0, K)));
      } else
        v
          ? ((l = r[H](h.val[G][1])),
            2 === h.type
              ? ((g = r[H](h.val[G][0])), h[H].push([g, l]))
              : h[H].push([void 0, l]))
          : ((l = h[H][G][1]), 2 === h.type && (g = h[H][G][0]));
      w && (w += u);
      D
        ? (w += g + (p || l ? '=' : '') + l)
        : (G || (w += r[H](F) + (p || l ? '=' : '')),
  ...
  k.expandUnnamed = function (h, p, D, u, K) {
    ...
    for (v = h.val.length; g < v; g++) {
      if (K) var B = r[w](h.val[g][1].substring(0, K));
        ...
        H
          ? ((B = r[w](h.val[g][1])),
            h[w].push([2 === h.type ? r[w](h.val[g][0]) : void 0, B]))
          : (B = h[w][g][1]);
      F && (F += u);
      if (2 === h.type) {
  ...
  E.expand = function (h, p) {
    ...
    for (var u = 0, K = this.parts.length; u < K; u++)
      D +=
  ...
  E.parse = function () {
    var h = this.expression,
      ...
      w = 0,
      H = function (t) {
        if (t.match(K)) throw Error('Invalid Literal "' + t + '"');
        return t;
      };
    for (p.lastIndex = 0; ; ) {
      var v = p.exec(h);
      if (null === v) {
        F.push(H(h.substring(w)));
        break;
      } else F.push(H(h.substring(w, v.index))), (w = v.index + v[0].length);
      if (!A[v[1]])
        throw Error('Unknown Operator "' + v[1] + '" in "' + v[0] + '"');
      if (!v[3]) throw Error('Unclosed Expression "' + v[0] + '"');
      var g = v[2].split(',');
      for (var B = 0, G = g.length; B < G; B++) {
        var l = g[B].match(D);
        if (null === l)
          throw Error('Invalid Variable "' + g[B] + '" in "' + v[0] + '"');
        if (l[1].match(u))
      ...
      if (!g.length)
        throw Error('Expression Missing Variable(s) "' + v[0] + '"');
    ...
    if (void 0 !== p && null !== p)
      if ('[object Array]' === String(Object.prototype.toString.call(p))) {
        ...
        for (h = p.length; u < h; u++)
          void 0 !== p[u] &&
            null !== p[u] &&
            D.val.push([void 0, String(p[u])]);
        D.val.length && (D.type = 3);
      } else if (
        '[object Object]' === String(Object.prototype.toString.call(p))
      ) {
        for (u in p)
          q.call(p, u) &&
            void 0 !== p[u] &&
            null !== p[u] &&
            D.val.push([u, String(p[u])]);
        D.val.length && (D.type = 2);
      } else (D.type = 1), D.val.push([void 0, String(p)]);
    return D;
  };
  r.expand = function (h, p) {
    var D = new k(h).expand(p);
    return new r(D);
  };
  return k;
});
